...
public class FoToXML {
    ...
    public static void main(String[] args) {
        try {
            ...
            Element racine = new Element("Cours");
                    ...
                    if("list-block".equals(child.getName())){
                        ...
                        if (child.getChildren().size()==1){
                            ...
                            if (Pattern.matches("\\d.",lab)){
                                ...
                                String part ="";
                                if(parti!=null){
                                    part = parti.getChild("label").getText();
                                }
                                ...
                                String part = "";
                                if (chap!=null){
                                    part = chap.getChild("label").getText();
                                }
    ...
    public static String conteneur(Element paragraphe, Element Chapitre, Element parti){
        String part ="";
        if (paragraphe!=null){
            part = paragraphe.getChild("label").getText();
        }
        else if (Chapitre!=null){
            part = Chapitre.getChild("label").getText();
        }
        else if (parti!=null){
            part = parti.getChild("label").getText();
        }
    ...
    public static void insert(Element notion, Element element){
      if (notion!=null) {
